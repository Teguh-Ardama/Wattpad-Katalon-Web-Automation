...
WebUI.verifyElementPresent(findTestObject('Form Sign Up/Form Sign up with email/Error Handle/div_The username you have chosen is invalid. Please try another name'), 
    0)
