...
WebUI.click(findTestObject('Form Sign Up/Form Sign up with email/button_Show Password'))

WebUI.click(findTestObject('Form Sign Up/Form Sign up with email/button_Hide Password'))

WebUI.setText(findTestObject('Form Sign Up/Form Sign up with email/input_Re-enter Password'), confirmPassword)

WebUI.click(findTestObject('Form Sign Up/Form Sign up with email/button_Show Re-enter Password'))

WebUI.click(findTestObject('Form Sign Up/Form Sign up with email/button_Hide Re-enter Password'))
...
WebUI.verifyElementClickable(findTestObject('Form Sign Up/Form Sign up with email/span_Sign up with email (sign up form)'))
