...
WebUI.sendKeys(findTestObject('Form Sign Up/Form Sign up with email/input_Re-enter Password'), Keys.chord(Keys.ENTER))

WebUI.verifyElementPresent(findTestObject('Form Sign Up/Form Sign up with email/Error Handle/div_Passwords do not match'), 
    0)
