...
WebUI.sendKeys(findTestObject('Form Sign Up/Form Sign up with email/input_Password'), Keys.chord(Keys.ENTER))

WebUI.verifyElementPresent(findTestObject('Form Sign Up/Form Sign up with email/Error Handle/div_Your password doesnt meet the requirements'), 
    0)
