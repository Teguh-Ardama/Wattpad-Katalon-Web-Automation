...
WebUI.click(findTestObject('Form Sign in/Login with Email/button_Show'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Form Sign in/Login with Email/button_Hide'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Form Sign in/Login with Email/span_Log in'))

String actualUrl = WebUI.getUrl()

WebUI.verifyMatch(actualUrl, expectedURL, true)
